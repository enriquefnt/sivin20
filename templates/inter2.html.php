...
<div class="col-sm-2">
  ...
  <select name="NOTIINTERNADOS[IntSala]" id="IntSala" class="form-control form-control-sm">
   ...
   <!-- <div class="col-sm-4">
    ...
    <input type="text" id="diagnosticos" class="form-control form-control-sm" name="NOTIINTERNADOS[diagnosticos]" placeholder="Ingrese un motivo de ingreso" /><br>
    <input type="button" value="Agregar motivo" id="agregar-diagnostico" class="btn btn-primary" />
</div> -->

<!-- <div class="col-sm-4">
    <label class="form-label-sm" for="diagnosticos">Motivos de ingreso</label>
    <input type="text" id="diagnosticos" class="form-control form-control-sm" name="diagnosticos" placeholder="Ingrese un motivo de ingreso" /><br>
    <input type="button" value="Agregar motivo" id="agregar-diagnostico" class="btn btn-primary" />
</div> -->
...
$(document).ready(function() {
    // Resto de tu código para agregar diagnósticos y mostrar la lista
...
$(document).ready(function() {
    ...
    $("#agregar-diagnostico").click(function() {
        ...
        // Actualizamos el valor del campo oculto con el array de diagnósticos
